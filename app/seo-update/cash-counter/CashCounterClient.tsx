        ...
        <div className="print:hidden space-y-6">
          <div className="rounded-2xl border border-line dark:border-white/10 bg-surface dark:bg-white/[0.03] p-5">
            ...
            <div className="grid grid-cols-2 gap-2">
              <button onClick={reset} className="rounded-lg border border-line dark:border-white/10 text-ink dark:text-white text-sm py-2.5 hover:border-indigo hover:text-indigo transition-colors">Reset</button>
              <button onClick={printSheet} className="rounded-lg border border-line dark:border-white/10 text-ink dark:text-white text-sm py-2.5 hover:border-indigo hover:text-indigo transition-colors">Print</button>
              <button onClick={downloadPDF} className="rounded-lg border border-line dark:border-white/10 text-ink dark:text-white text-sm py-2.5 hover:border-indigo hover:text-indigo transition-colors">Download PDF</button>
              <button onClick={copySummary} className="rounded-lg border border-line dark:border-white/10 text-ink dark:text-white text-sm py-2.5 hover:border-indigo hover:text-indigo transition-colors">
                {copied ? "Copied!" : "Copy Summary"}
              </button>
              <button onClick={shareOnWhatsApp} className="col-span-2 rounded-lg bg-indigo text-white text-sm py-2.5 hover:bg-indigo-dark transition-colors">
                Share on WhatsApp
              </button>
            </div>
          </div>
